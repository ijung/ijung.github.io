...
tags: [baekjoon, kotlin, 코틀린, 백준, 골드, 수학, 정수론, 유클리드 호제법]
toc: true
toc: true
math: true
mermaid: true
...
> 
> 우선, (A<sub>n</sub> - A<sub>n-1</sub>)들의 최대 공약수를 구하자!
### 코드
```kotlin
var gcdValue = 0
