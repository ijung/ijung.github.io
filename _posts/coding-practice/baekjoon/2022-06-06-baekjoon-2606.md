...
tags: [baekjoon, kotlin, 백준, 실버, 그래프, 그래프 이론, 그래프 탐색, 너비 우선 탐색, bfs, 깊이 우선 탐색, dfs]
toc: true
math: true
mermaid: true
comments: true
...
## ![screencapture](../coding-practice/baekjoon/screencapture-acmicpc-net-problem-2606.png)
