---
title: 깨끗한 단위 테스트를 위한 다섯 가지 규칙 - F.I.R.S.T
author: June
date: 2022-07-19 02:02:00 +0900
categories: [개발관련 개념들 정리]
tags: [개발관련 개념들 정리, 테스트, 단위 테스트, unit test]
toc: true
toc: true
math: true
mermaid: true
...
2. Independent: 독립적으로
- 각 테스트는 서로 의존하면 안 된다.
- 테슽트가 서로에게 의존하면 하나가 실패할 때 나머지도 잇달아 실패하므로 원인을 진단하기 어려워지며 후반 테스트가 찾아내야 할 결함이 숨겨진다.
