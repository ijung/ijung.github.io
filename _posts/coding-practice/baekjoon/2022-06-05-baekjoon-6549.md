...
tags: [baekjoon, kotlin, 백준, 플래티넘, 자료 구조, 세그먼트 트리, 분할 정복, 스택, 풀이]
toc: true
math: true
mermaid: true
comments: true
...
## ![screencaptures](../coding-practice/baekjoon/screencapture-acmicpc-net-problem-6549.png)

# 스택 사용 방법
## 풀이
### ![개념](../coding-practice/baekjoon/baekjoon-6549-stack.png)
## 답
### kotlin code
```kotlin
fun main() {
...
# 분할 정복법
## 풀이
### ![개념](../coding-practice/baekjoon/baekjoon-6549-dc.png)
## 답
### kotlin code
```kotlin
fun main() {
...
# Segment Tree + 분할 정복법
## 풀이
### ![개념](../coding-practice/baekjoon/baekjoon-6549-st-dc.png)
## 답
### kotlin code
```kotlin
fun main() {
