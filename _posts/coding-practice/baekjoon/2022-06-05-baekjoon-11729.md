...
tags: [baekjoon, kotlin, 백준, 실버, 재귀, 풀이]
toc: true
math: true
mermaid: true
comments: true
...
## ![screencaptures](../coding-practice/baekjoon/screencapture-acmicpc-net-problem-11729.png)

# 풀이
## 개념
![하노이 탑 이동 순서 풀이](../coding-practice/baekjoon/baekjoon-11729-explanation.png)
## 요약
> 즉, 디스크의 수가 n개일 때,
