---
title: github jekyll chirpy 테마에 utterances 댓글 창 추가 하기
author: June
...
## 1. utterances에 대하여
utterances는 GitHub 문제를 기반으로 하는 가벼운 댓글 위젯이다. 블로그 댓글, 위키 페이지 등에 GitHub 문제를 사용할 수 있다.
## 2. 특징
- 오픈 소스. 🙌
- 추적 없음, 광고 없음, 완전 무료. 📡🚫
...
![utterance-install](/posts/tips/etc/screencapture-github-apps-utterances.png)
...
![utterance-permissions](/posts/tips/etc/screencapture-github-apps-utterances-installations-new-permissions.png)
...
![utteranc-es](/posts/tips/etc/screencapture-utteranc-es.png)
...
## 5. 끝
![complete](/posts/tips/etc/screencapture-complete.png)