...
tags: [baekjoon, kotlin, 백준, 골드, 수학, 정수론, 조합론, 분할 정복을 이용한 거듭제곱, 분할 정복, 모듈로 곱셈 역원, 페르마의 소정리, 풀이]
toc: true
math: true
mermaid: true
comments: true
...
## ![screencapture](../coding-practice/baekjoon/screencapture-acmicpc-net-problem-11401.png)

# 풀이
### Background
- 이항 계수[[이항 계수](https://ko.wikipedia.org/wiki/%EC%9D%B4%ED%95%AD_%EA%B3%84%EC%88%98)]  
![이항 계수](../coding-practice/baekjoon/baekjoon-11041-binomial-coefficient.png)
- 페르마의 소정리[[페르마의 소정리](https://ko.wikipedia.org/wiki/%ED%8E%98%EB%A5%B4%EB%A7%88%EC%9D%98_%EC%86%8C%EC%A0%95%EB%A6%AC)]  
![페르마의 소정리](../coding-practice/baekjoon/baekjoon-11041-fermats-little-theorem.png)
    > 페르마의 소정리를 이용한 ^-1 없애기  
      1. a^p-1 ≡ 1        (mod p)  
      2. a * a^p-2 ≡ 1  (mod p)  
      3. a^p-2 ≡ 1 / a  (mod p)  
...
![분배법칙](../coding-practice/baekjoon/baekjoon-11041-distributive.png)
    > fyi  
